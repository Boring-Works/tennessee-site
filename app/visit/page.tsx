...
const CompassRose = () => (
  <svg viewBox="0 0 60 60" fill="none" stroke="currentColor" strokeWidth="1" className={styles["compass-rose"]}>
    ...
    {/* Direction labels */}
    <text x="30" y="18" textAnchor="middle" fontSize="6" fill="currentColor" opacity="0.7" fontWeight="bold">N</text>
    <text x="30" y="56" textAnchor="middle" fontSize="5" fill="currentColor" opacity="0.5">S</text>
    <text x="8" y="32" textAnchor="middle" fontSize="5" fill="currentColor" opacity="0.5">W</text>
    <text x="52" y="32" textAnchor="middle" fontSize="5" fill="currentColor" opacity="0.5">E</text>
  </svg>
);
  ...
  return (
    <>
      ...
      <section className={styles["visit-hero"]} aria-labelledby="visit-heading">
        ...
        <span className={`${styles["visit-hero-corner"]} ${styles["visit-hero-corner--tl"]}`} aria-hidden="true" />
        <span className={`${styles["visit-hero-corner"]} ${styles["visit-hero-corner--tr"]}`} aria-hidden="true" />
        <span className={`${styles["visit-hero-corner"]} ${styles["visit-hero-corner--bl"]}`} aria-hidden="true" />
        <span className={`${styles["visit-hero-corner"]} ${styles["visit-hero-corner--br"]}`} aria-hidden="true" />
        ...
        <div className={styles["visit-hero-content"]}>
          ...
          <p className={styles["visit-hero-badge"]}>
            ...
            <span className={styles["visit-hero-badge-sep"]} aria-hidden="true">·</span>
          ...
          >
            <span className={styles["visit-hero-cta-seal"]} aria-hidden="true">★</span>
            Book Your Tour
          </a>
      ...
      <section className={styles["visit-figures"]} aria-labelledby="figures-heading">
        <div className={styles["visit-figures-inner"]}>
          <header className={styles["visit-figures-header"]}>
            <p className={styles["visit-figures-eyebrow"]}>Hallowed Ground</p>
          ...
          <div className={styles["visit-figures-grid"]}>
            {historicalFigures.map((figure) => (
              <article key={figure.name} className={styles["visit-figure"]}>
                ...
                <PortraitFrame
                  initials={figure.name.split(' ').map(n => n[0]).join('')}
                ...
                {/* Corner accents */}
                <span className={`${styles["visit-figure-corner"]} ${styles["visit-figure-corner--tl"]}`} aria-hidden="true" />
                <span className={`${styles["visit-figure-corner"]} ${styles["visit-figure-corner--br"]}`} aria-hidden="true" />
              </article>
            ))}
          </div>
        </div>
            ...
            {experienceHighlights.map((highlight, index) => (
              <article key={highlight.moment} className={styles["visit-moment"]}>
                ...
                <div className={styles["visit-moment-number-frame"]} aria-hidden="true">
                  <span className={styles["visit-moment-number"]}>{['I', 'II', 'III', 'IV'][index]}</span>
                </div>
      ...
      {/* ============================================
          ...
          ============================================ */}
      <section id="plan-your-visit" className={styles["visit-practical"]} aria-labelledby="practical-heading">
        <div className={styles["visit-practical-inner"]}>
          ...
          <div className={styles["visit-practical-grid"]}>
            ...
            <div className={styles["visit-card"]}>
              {/* Card corner accents */}
              <span className={`${styles["visit-card-corner"]} ${styles["visit-card-corner--tl"]}`} aria-hidden="true" />
              <span className={`${styles["visit-card-corner"]} ${styles["visit-card-corner--br"]}`} aria-hidden="true" />
              <h3 className={styles["visit-card-title"]}>
                <svg className={styles["visit-card-icon"]} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
              ...
              <dl className={styles["visit-hours"]}>
                ...
                <div className={`${styles["visit-hours-row"]} ${styles["visit-hours-row--closed"]}`}>
                  <dt>Monday</dt>
                  <dd>Closed</dd>
                </div>
              </dl>
            ...
            <div className={`${styles["visit-card"]} ${styles["visit-card--featured"]}`}>
              ...
              >
                <span className={styles["visit-book-btn-seal"]} aria-hidden="true">★</span>
                Book Now
                <span aria-hidden="true">→</span>
              </a>
              <p className={styles["visit-book-note"]}>
            ...
            <ul className={styles["visit-prepare-list"]}>
              {whatToExpect.recommendations.map((rec, index) => (
                <li key={index} className={styles["visit-prepare-item"]}>
                  <svg className={styles["visit-prepare-icon"]} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
        ...
        <div className={styles["visit-journey-inner"]}>
          ...
          <div className={styles["visit-journey-content"]}>
            ...
            <div className={styles["visit-journey-address"]}>
              ...
              <p className={styles["visit-journey-directions"]}>
                {location.directions}
              </p>
      ...
      <section className={styles["visit-closing"]} aria-labelledby="closing-heading">
        {/* Corner brackets */}
        <span className={`${styles["visit-closing-corner"]} ${styles["visit-closing-corner--tl"]}`} aria-hidden="true" />
        <span className={`${styles["visit-closing-corner"]} ${styles["visit-closing-corner--tr"]}`} aria-hidden="true" />
        <span className={`${styles["visit-closing-corner"]} ${styles["visit-closing-corner--bl"]}`} aria-hidden="true" />
        <span className={`${styles["visit-closing-corner"]} ${styles["visit-closing-corner--br"]}`} aria-hidden="true" />
        ...
        <div className={styles["visit-closing-inner"]}>
          ...
          <div className={styles["visit-closing-rule"]} aria-hidden="true">
            ...
            <span className={styles["visit-closing-rule-line"]} />
            <span className={`${styles["visit-closing-rule-flourish"]} ${styles["visit-closing-rule-flourish--flip"]}`}>❧</span>
          </div>
          ...
          <div className={styles["visit-closing-cta-group"]}>
            ...
            >
              <span className={styles["visit-closing-cta-seal"]} aria-hidden="true">★</span>
              Book Your Tour
            </a>
            <Link href="/events" className={`${styles["visit-closing-cta"]} ${styles["visit-closing-cta--secondary"]}`}>
              View 2026 Events
            </Link>
          </div>
          ...
          <div className={`${styles["visit-closing-rule"]} ${styles["visit-closing-rule--bottom"]}`} aria-hidden="true">
            <span className={styles["visit-closing-rule-line"]} />
