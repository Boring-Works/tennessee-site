      ...
      <div className={styles.mainContent}>
        ...
        <section className={styles.hero}>
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroSubtitle}>
              Primary documents from the founding of Tennessee&apos;s government. Examined.
              Verified. Preserved.
            </p>
        ...
        <section id="blount-letter" className={styles.featuredSection}>
          <div className={styles.container}>
            ...
            />
            <ContextPanel>
              Blount wrote this letter on October 20, 1790, nine days after arriving. The
              &ldquo;Glass Windows&rdquo; detail wasn&apos;t idle observation—on the frontier, most
              settlers used oiled paper or wooden shutters. Glass windows signaled that Rocky Mount
              was a proper seat of government, not a crude outpost.
            </ContextPanel>
            <CuratorNote>
        ...
        <section id="washington-question" className={styles.section}>
          <div className={styles.container}>
            ...
            <ContextPanel>
              ...
              answer would determine where federal authority took root west of the Appalachians.
              Knox pointed to the Holston settlements—and William Cobb&apos;s home became that seat
              of power.
            </ContextPanel>
          </div>
        </section>
        ...
        <section id="appointment" className={styles.section}>
          <div className={styles.container}>
            ...
            <ContextPanel>
              ...
              Blount commanded enough respect from both sides. Washington agreed—Blount was
        ...
        <section id="federal-authority" className={styles.section}>
          <div className={styles.container}>
            ...
            />
            <ContextPanel>
              This proclamation, signed November 11, 1791, made the Treaty of Holston binding
              federal law. Countersigned by Secretary of State Thomas Jefferson, it required all
              U.S. officers to enforce the terms Blount had negotiated with 40 Cherokee chiefs that
              July.
            </ContextPanel>
          </div>
        </section>
        ...
        <section id="treaty-signers" className={styles.signersSection}>
          <div className={styles.container}>
            ...
            <div className={styles.signersIntro}>
              <p>
                On July 2, 1791, after weeks of negotiation at White&apos;s Fort, these leaders
                signed on behalf of the Cherokee Nation. Their names are preserved in the treaty
                record.
              </p>
            </div>
            ...
            <div className={styles.signersFooter}>
              ...
              <p className={styles.signersDescendants}>
                The Cherokee Nation, Eastern Band of Cherokee Indians, and United Keetoowah Band
                carry these names forward today.
              </p>
            </div>
          </div>
        </section>
