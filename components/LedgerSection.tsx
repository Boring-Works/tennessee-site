...
const CompassRose = () => (
  <svg viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
    ...
    {/* Letters */}
    <text x="24" y="9" textAnchor="middle" fontSize="4" fill="currentColor" opacity="0.7" fontFamily="serif">N</text>
    <text x="24" y="45" textAnchor="middle" fontSize="4" fill="currentColor" opacity="0.5" fontFamily="serif">S</text>
    <text x="7" y="25.5" textAnchor="middle" fontSize="4" fill="currentColor" opacity="0.5" fontFamily="serif">W</text>
    <text x="41" y="25.5" textAnchor="middle" fontSize="4" fill="currentColor" opacity="0.5" fontFamily="serif">E</text>
  </svg>
);
...
export default function LedgerSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className={styles["ledger-section"]}
    ...
    >
      ...
      <div className={styles["ledger-container"]}>
        ...
        <div className={`${styles["ledger-book"]} ${isVisible ? styles["ledger-book--visible"] : ''}`}>
          {/* 1776 - The Promise */}
          <article className={`${styles["ledger-card"]} ${styles["ledger-card--promise"]}`}>
            ...
            {/* Wax seal - faded gray */}
            <div className={`${styles["ledger-seal"]} ${styles["ledger-seal--faded"]}`} aria-hidden="true">
          ...
          <article className={`${styles["ledger-card"]} ${styles["ledger-card--proof"]}`}>
            ...
            <div className={`${styles["ledger-seal"]} ${styles["ledger-seal--active"]}`} aria-hidden="true">
        ...
        {/* Bottom stat bar */}
        <div className={`${styles["ledger-stats"]} ${isVisible ? styles["ledger-stats--visible"] : ''}`}>
