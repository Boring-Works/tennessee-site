      ...
      <div className={styles["showcase-container"]}>
        ...
        <header className={styles["showcase-header"]}>
          ...
          <p className={styles["showcase-intro"]}>
            {eventCount} events celebrating America&apos;s 250th and Tennessee&apos;s 230th—from scholarly lectures to frontier festivals.
          </p>
        </header>
        ...
        <div className={styles["showcase-grid"]}>
          ...
          <div className={`${styles["showcase-divider"]} ${styles["showcase-divider--vertical"]}`} aria-hidden="true">
          ...
          <article className={`${styles["showcase-category"]} ${styles["showcase-lectures"]}`}>
            ...
            <div className={styles["showcase-speakers"]}>
              ...
              {lectures.length > 3 && <span className={styles["showcase-more"]}>+{lectures.length - 3} more</span>}
            </div>
        ...
        <footer className={styles["showcase-footer"]}>
          <div className={styles["showcase-stats"]}>
            ...
            <div className={styles["showcase-stat-divider"]} aria-hidden="true">◆</div>
            <div className={styles["showcase-stat"]}>
