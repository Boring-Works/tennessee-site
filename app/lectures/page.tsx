      ...
      <section className={styles["series-hero"]} aria-labelledby="series-heading">
        <div className={styles["series-hero-content"]}>
          ...
          <p className={styles["series-milestone-badge"]}>
            <span className={styles["series-milestone-icon"]} aria-hidden="true">★</span>
                ...
                <div className={styles["series-lecture-content"]}>
                  ...
                  <header className={styles["series-lecture-header"]}>
                    <div className={styles["series-lecture-date-block"]}>
                      <time dateTime={lecture.date} className={styles["series-lecture-date"]}>
                        <span className={styles["series-lecture-date-month"]}>{shortDate.month}</span>
                    ...
                    <div className={styles["series-lecture-title-group"]}>
                      ...
                      <p className={styles["series-lecture-full-date"]}>{formatDate(lecture.date)}</p>
                    </div>
                  </header>
                  ...
                  <details className={styles["series-lecture-bio"]}>
                    <summary className={styles["series-lecture-bio-toggle"]}>
                      ...
                      <svg className={styles["series-lecture-bio-icon"]} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                  ...
                  {connection && (
                    <p className={styles["series-lecture-connection"]}>
                      <span className={styles["series-lecture-connection-icon"]} aria-hidden="true">→</span>
                      {connection}
                    </p>
                  )}
                  ...
                  {/* Special note */}
                  {lecture.note && (
                    <p className={styles["series-lecture-note"]}>{lecture.note}</p>
                  )}
                </div>
              </article>
            );
        ...
        <div className={styles["series-beyond-inner"]}>
          ...
          <article className={styles["series-beyond-event"]}>
            ...
            <div className={styles["series-beyond-event-content"]}>
              ...
              <p className={styles["series-beyond-event-desc"]}>{additionalProgramming.description}</p>
      ...
      <section className={styles["series-cta"]} aria-labelledby="series-cta-heading">
        <div className={styles["series-cta-inner"]}>
          ...
          <div className={styles["series-cta-actions"]}>
            <Link href="/visit" className={`${styles["series-cta-btn"]} ${styles["series-cta-btn--primary"]}`}>
              Plan Your Visit
            </Link>
            <Link href="/events" className={`${styles["series-cta-btn"]} ${styles["series-cta-btn--secondary"]}`}>
              Full 2026 Calendar
            </Link>
          </div>

          <p className={styles["series-cta-location"]}>
            <svg className={styles["series-cta-location-icon"]} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
