...
export function ConsolidatedClose() {
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div ref={acknowledgeRef} className="py-12 md:py-16 bg-cream border-t border-secondary/10">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <p
            className={`text-sm md:text-base text-text-light leading-relaxed fade-in-up ${acknowledgeVisible ? 'visible' : ''}`}
          >
      ...
      <div ref={ctaRef} className="relative bg-primary overflow-hidden">
        ...
        <div className="relative z-10 py-20 md:py-28 px-6">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div
              className={`flex items-center justify-center gap-3 mb-8 fade-in-up ${ctaVisible ? 'visible' : ''}`}
              aria-hidden="true"
            >
            ...
            <Link
              href="/visit"
              className={`group inline-flex items-center justify-center gap-3 bg-accent text-primary px-10 py-5 text-base font-bold uppercase tracking-[0.1em] transition-all duration-300 hover:bg-[#d4af37] hover:-translate-y-0.5 hover:shadow-[0_12px_32px_rgba(201,162,39,0.4)] fade-in-up stagger-3 ${ctaVisible ? 'visible' : ''}`}
            >
            ...
            {/* Closing tagline */}
            <p
              className={`mt-10 font-serif-elegant text-base md:text-lg italic text-accent/80 fade-in-up stagger-4 ${ctaVisible ? 'visible' : ''}`}
            >
            ...
            <div
              className={`flex items-center justify-center gap-3 mt-8 fade-in-up stagger-5 ${ctaVisible ? 'visible' : ''}`}
              aria-hidden="true"
            >
