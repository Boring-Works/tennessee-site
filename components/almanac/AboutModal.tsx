        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-4 md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-lg md:w-full bg-almanac-midnight border border-almanac-gold/30 rounded-lg shadow-2xl z-[70] overflow-hidden"
              role="dialog"
              aria-modal="true"
